(()=>{var l=`
    ...
    `;var o=typeof window<"u"&&window?.HTMLElement,r=class extends o{constructor(){super();let e=document.createElement("style");e.innerHTML=`
        ...
        `;let i=this.attachShadow({mode:"open"});this.getAttribute("nonce")&&e.setAttribute("nonce",this.getAttribute("nonce"));let a=this.getAttribute("mode")??"light",t=l;a==="dark"&&(t=t.replace(/#0D0D0E/g,"rgba(255, 255, 255, 0)")),i.appendChild(e),i.innerHTML=i.innerHTML+t}connectedCallback(){new ResizeObserver(this.resetWidth.bind(this)).observe(this),this.resetWidth(),this.setAttribute("rendered","")}resetWidth(){this.style.setProperty("--width",`${this.clientWidth}px`)}};typeof window<"u"&&window.customElements.define("iphone-16-max",r);})();